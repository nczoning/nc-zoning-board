...
- Zoomed all the way out (and during the showcase fly-over), shadows now cover the whole city instead of a box that tracked the camera and left the far side unlit.
